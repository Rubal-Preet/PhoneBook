...
app.post("/adduser", (req, res) => {
    ...
    console.log(myData);
   if(myData.name=='' || myData.mobile==null || myData.email=='' || myData.dob==null )
   {
...
app.get('/searchuser',function(req,res){
  ...
  var nameRegex = new RegExp(req.query.uname);
 
  user.find({name:{$regex: nameRegex, $options: 'i'}},(function(err,users){
    if(err)
    {
      console.log(error);
    }
